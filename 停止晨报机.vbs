' =====================================================================
' Morning Brief launcher: stop   (double-click to stop the background instance)
' =====================================================================
...
On Error Resume Next
rc = sh.Run(cmd & " stop", 0, True)
If Err.Number <> 0 Then
  MsgBox "Failed to run stop: " & Err.Description, 16, "Morning Brief"
  WScript.Quit 1
End If
On Error GoTo 0
...
If rc <> 0 Then
  ...
  sh.Run "cmd.exe /k """ & cmd & " stop""", 1, False
  WScript.Quit rc
End If
